        ...
        <div className="flex items-center justify-between h-20">
          ...
          <Link href="/" className="group flex items-center space-x-3">
            ...
            <div className="hidden sm:block">
              ...
              <div className="text-xs text-gray-400 font-medium tracking-wider">BLUE SKY ANIME</div>
            </div>
          </Link>
          ...
          <div className="hidden md:flex items-center">
            <div className="relative group">
              <input
                ...
                className="w-72 px-5 py-3 pl-12 bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl focus:outline-none focus:border-purple-400 focus:bg-white/20 text-white placeholder-white/60 transition-all duration-300 group-hover:bg-white/15"
                onKeyPress={(e) => {
              ...
              />
              <Search className="absolute left-4 top-1/2 transform -translate-y-1/2 text-white/60 group-hover:text-white/80 transition-colors duration-300" size={20} />
              <div className="absolute inset-0 rounded-2xl bg-gradient-to-r from-purple-600/0 to-blue-600/0 group-hover:from-purple-600/10 group-hover:to-blue-600/10 transition-all duration-300" />
            </div>
          </div>
